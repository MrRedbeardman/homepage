...
function get_list_view_html($product_id, $product) {
    $output = "";
    $output = $output . '<a class="fancybox-thumb" rel="fancybox-thumb" href="' . $product["img"] . '" title="' . $product["name"] . " | " . $product["description"] . " | " . $product["location"] . " | " . $product["year"] .'">';
    $output = $output . '<img class="img-circle" src="' . $product["thumb"] . '">';
    $output = $output .  "</a>";
    return $output; 
}
...
$products[102] = array(
    ...
    "description" => "Snow falling around a streetlight",
...
$products[103] = array(
    ...
    "description" => "Badlands in Summer",
